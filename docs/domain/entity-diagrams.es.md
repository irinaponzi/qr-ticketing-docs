...
Diagramas de clases completos para todas las entidades de dominio en ambos contextos acotados.

---

## Contexto de Tickets — Diagrama de clases completo
...
## Contexto de Validación — Diagrama de clases completo
